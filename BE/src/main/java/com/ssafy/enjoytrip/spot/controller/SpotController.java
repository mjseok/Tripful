...
//		System.out.println(sidoList);
	...
	@GetMapping("/count")
	public ResponseEntity<Integer> listCount(@RequestParam("sidoid") int sido, @RequestParam("gugunid") int gugun, @RequestParam("pageno") int pageno, @RequestParam("theme") int theme) throws Exception {
...
//		System.out.println("리스트는 : "+list);
		return new ResponseEntity<Integer>(spotNum,HttpStatus.OK);
	}
