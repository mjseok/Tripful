        ...
        (r = [
          {
            ...
            value: function () {
              ...
              if (this.intersectionListenerSupported())
                for (
                  var r = new IntersectionObserver(this.animateElements.bind(this), {
                      root: null,
                      rootMargin: "20px",
                      threshold: 0.5,
                    }),
            ...
            value: function (e, t) {
              ...
              e.forEach(function (e) {
                ...
                return n.duration <= 0
                  ...
                  : (!t && !r.elementIsInView(e)) || (t && e.intersectionRatio < 0.5)
                  ...
                  (((i = s) >= t.end && "inc" == a) || (i <= t.end && "dec" == a)) &&
                    ...
                    i != t.end &&
                      (e.innerHTML = r.applySeparator(
                        t.decimals <= 0 ? parseInt(t.end) : parseFloat(t.end).toFixed(t.decimals),
                        t
                      )));
              }, t.delay);
            },
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              return (
                (r = t.currency ? this.convertToCurrencySystem(e, t) : r), this.applySeparator(r, t)
              );
            },
          },
          {
