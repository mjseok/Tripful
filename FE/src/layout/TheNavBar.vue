<template>
  <div>
    <b-navbar toggleable="lg" type="transparent" variant="transparent" class="nav">
      <b-navbar-brand id="nav" href="#">
        <router-link to="/"
          ><img src="@/assets/logo2.png" alt="" width="25%" style="text-align: 'left'"
        /></router-link>
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item class="align-self-center link" @click.prevent="onClickLogout" v-if="userInfo"
            >로그아웃</b-nav-item
          >
          <!-- before login -->
